...
export const MIR_2026_31_40_QUESTIONS: TrainingQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { id: "A", label: "A", text: "CURB-65 de 4-5 puntos (confusión, urea elevada, frecuencia respiratoria ≥30, hipotensión, y edad ≥65 años); indica neumonía grave con alto riesgo de mortalidad, requiriendo valoración de ingreso en UCI." },
    ...
    keyPoints: [
      ...
      "CURB-65 de 4-5 puntos: neumonía grave, alta mortalidad, valorar ingreso en UCI/cuidados intermedios.",
