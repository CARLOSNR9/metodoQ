...
/**
 * Convocatoria UCC — Edición #3 (19 jul 2025) · Preguntas #31–#40.
...
export const UCC_CONV_2025_07_19_31_40_QUESTIONS: TrainingQuestion[] = [
  ...
  },
  {
    ...
    statement: "Adolescente masculino de 13 años, con antecedente conocido de Anemia de Células Falciformes (enfermedad homocigota HbSS), es traído a urgencias por presentar fiebre de 39.0°C, dolor torácico severo de características pleuríticas y tos seca de 24 horas de evolución. Al examen físico: luz taquipneico (FR 35 rpm), SatO2 86% al aire ambiente, FC 120 lpm. A la auscultación pulmonar se evidencian crépitos y disminución del murmullo vesicular en las bases de ambos hemitórax. El hemograma muestra una Hemoglobina de 6.0 g/dL (basal de 8.5 g/dL) con leucocitosis de 22,000/mm³. La radiografía de tórax confirma nuevos infiltrados alveolares difusos bilaterales. Se inicia oxígeno suplementario, hidratación y analgesia con opioides. ¿Cuál es el pilar terapéutico INMEDIATO que disminuye de forma contundente la mortalidad e hipoxemia en este paciente?",
    options: [
      {
        id: "A",
        label: "A",
