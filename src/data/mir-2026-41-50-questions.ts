...
export const MIR_2026_41_50_QUESTIONS: TrainingQuestion[] = [
  {
    ...
    options: [
      ...
      { id: "C", label: "C", text: "Signo de Kussmaul, compatible con una pericarditis constrictiva crónica, cuyo manejo es médico con diuréticos y restricción de sal, sin necesidad de drenaje ni de pericardiectomía, dado que el derrame no compromete el llenado ventricular." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", label: "B", text: "Debe colocarse un tubo de toracostomía en el neumotórax espontáneo, aunque sea pequeño y el paciente esté estable, ya que la observación aislada conlleva un riesgo inaceptable de progresión a neumotórax a tensión." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", label: "B", text: "Laparotomía exploratoria urgente de entrada, sin ensayar manejo conservador, dado el antecedente de cirugía abdominal previa y el riesgo de que las bridas provoquen una estrangulación; la sonda nasogástrica y la fluidoterapia retrasan la cirugía y aumentan la mortalidad del paciente." },
      ...
      { id: "D", label: "D", text: "Colonoscopia urgente como primer paso diagnóstico y terapéutico, aunque la obstrucción sea de intestino delgado, ya que permite descomprimir el intestino y colocar una endoprótesis, evitando la cirugía y la necesidad de sonda nasogástrica en la mayoría de los casos de obstrucción." },
    ],
    correctOptionId: "A",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", label: "B", text: "Iniciar antibioterapia empírica de amplio espectro de inmediato, sin extraer hemocultivos previos, para no retrasar el tratamiento de una infección potencialmente grave, y solicitar el ecocardiograma si la fiebre persiste tras una semana de tratamiento antibiótico correcto, ya que la mayoría de las bacteriemias en usuarios de drogas se resuelven sin afectación valvular ni complicaciones embólicas." },
      { id: "C", label: "C", text: "Solicitar serologías virales (VIH, VHB y VHC) y tratamiento sintomático de la fiebre, dado que la causa más probable del cuadro en un usuario de drogas por vía parenteral es una infección viral sistémica aguda, no bacteriana, y los hemocultivos no aportarían información útil." },
      { id: "D", label: "D", text: "Diferir el estudio diagnóstico hasta la resolución completa de la fiebre con antitérmicos, dado que las lesiones cutáneas descritas no tienen relevancia diagnóstica y la mayoría de los cuadros febriles en este contexto son autolimitados y se resuelven en pocos días." },
    ],
    correctOptionId: "A",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", label: "B", text: "Repetir la misma dosis de benzodiacepina de forma repetida cada 5-10 minutos hasta que la crisis ceda, sin escalar a otros fármacos antiepilépticos, ya que las benzodiacepinas son los fármacos con mayor eficacia demostrada en el estatus epiléptico y la depresión respiratoria es excepcional incluso tras varias dosis repetidas en adultos jóvenes." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", label: "C", text: "Administrar grandes volúmenes de cristaloides y hemoderivados hasta normalizar completamente la presión arterial y la frecuencia cardíaca antes de considerar la intervención quirúrgica, ya que operar a un paciente hipotenso multiplica la mortalidad del procedimiento vascular y del acto anestésico en pacientes de edad avanzada." },
