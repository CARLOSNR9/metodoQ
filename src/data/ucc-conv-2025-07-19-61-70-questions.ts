...
/**
 * Convocatoria UCC — Edición #3 (19 jul 2025) · Preguntas #61–#70.
...
export const UCC_CONV_2025_07_19_61_70_QUESTIONS: TrainingQuestion[] = [
  {
    ...
    statement: "Niño de 8 años, previamente sano, es traído a urgencias por presentar fiebre de 39.0°C y cefalea severa de 3 días de evolución. Hace 4 horas presentó alteraciones conductuales (agresividad y lenguaje incoherente) seguidas de una convulsión focal motora en el hemicuerpo derecho que progresó a generalizada. Al examen físico: estuporoso, rigidez de nuca leve. Se realiza una Tomografía Computarizada (TC) de cráneo simple que es reportada como normal. Inmediatamente se realiza una punción lumbar con los siguientes hallazgos: Presión de apertura 18 cmH2O, Leucocitos 120/mm³ (85% linfocitos), Glucosa 65 mg/dL (glucemia sérica 90 mg/dL), Proteínas 80 mg/dL. Llama la atención la presencia de 800 Eritrocitos/mm³ en el tubo 1 y 850 Eritrocitos/mm³ en el tubo 4 (ausencia de aclaramiento traumático). ¿Cuál es el tratamiento empírico INMEDIATO de elección que cambia drásticamente la mortalidad y morbilidad neurológica?",
    options: [
      {
        id: "A",
        label: "A",
