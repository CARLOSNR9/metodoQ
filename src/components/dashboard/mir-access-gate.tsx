...
/**
 * Protege una página del módulo MIR: exige sesión y acceso MIR vigente, y
 * entrega el uid del usuario a `children`.
 */
export function MirAccessGate({ children }: { children: (userId: string) => ReactNode }) {
