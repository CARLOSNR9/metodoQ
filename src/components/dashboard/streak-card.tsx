  ...
  return (
    <section className="mq-glass group overflow-hidden rounded-3xl p-6 transition-all hover:border-orange-500/50">
      <div className="flex items-center gap-4">
        <div className={`flex h-12 w-12 items-center justify-center rounded-2xl transition-all duration-500 ${streakCount > 0 ? "bg-orange-500 text-white shadow-[0_0_20px_rgba(249,115,22,0.4)]" : "bg-slate-50 text-slate-500"}`}>
          <Flame size={24} className={streakCount > 0 ? "animate-pulse" : ""} fill={streakCount > 0 ? "currentColor" : "none"} />
        </div>
        <div>
          <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Racha Actual</p>
