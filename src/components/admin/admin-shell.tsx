  ...
  return (
    <main className="flex min-h-screen flex-1 flex-col bg-slate-50 md:flex-row">
      <aside className="relative z-20 w-full border-b border-slate-200 bg-slate-50 p-4 md:min-h-full md:w-64 md:border-b-0 md:border-r md:p-6">
        <div className="mb-8 hidden md:block">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <h2 className="text-sm font-semibold text-slate-900">Panel Admin</h2>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 hidden border-t border-slate-200 pt-4 md:block">
          ...
          {externalLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="inline-flex w-full items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium text-slate-500 transition-all hover:bg-slate-100 hover:text-slate-900"
            >
