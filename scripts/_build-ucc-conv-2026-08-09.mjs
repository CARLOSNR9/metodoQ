...
for (const batch of BATCHES) {
  const mdPath = path.join(__dirname, `../bateria_preguntas/edicion_5_lote_${batch.lote}.md`);
  ...
  const exportName = `UCC_CONV_2026_08_09_${sStr}_${eStr}_QUESTIONS`;
  const outputFileName = `ucc-conv-2026-08-09-${sStr}-${eStr}-questions.ts`;
...
const aggPath = path.join(__dirname, "../src/data/ucc-conv-2026-08-09-questions.ts");
