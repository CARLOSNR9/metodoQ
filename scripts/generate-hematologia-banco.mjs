...
const outPath = path.join(
  __dirname,
  "../src/data/dr-q-hematologia-banco-general-questions.ts",
);

/** @type {Array<{id:number,examArea:string,tags:string[],statement:string,options:string[],correct:string,explanation:string,keyPoints:string[],theory:string}>} */
const questions = [
  {
    id: 256,
    examArea: "Hematología / Anemias",
    tags: ["hematologia", "anemia", "macrocitica", "vcm"],
    statement:
...
• ASH Guidelines for Evaluation of Anemia.`,
  },
  {
    ...
    tags: ["hematologia", "anemia", "ferropenia", "laboratorio"],
    statement:
...
• UpToDate: Diagnosis of Iron Deficiency in Adults.`,
  },
  {
    ...
    tags: ["hematologia", "anemia", "ferropenia", "sangrado_digestivo"],
    statement:
    ...
    options: [
      "Iniciar hierro oral empírico y reevaluar en 3 meses.",
      "Solicitar colonoscopia para descartar neoplasia gastrointestinal.",
      "Solicitar transfusión de glóbulos rojos.",
      "Iniciar vitamina B12 intramuscular.",
    ],
    correct: "B",
    explanation:
...
• ASH Guidelines for Iron Deficiency Anemia.`,
  },
  {
    ...
    tags: ["hematologia", "anemia", "enfermedad_cronica", "ferritina"],
    statement:
...
• ASH Guidelines for Evaluation of Anemia.`,
  },
  {
    ...
    tags: ["hematologia", "anemia", "macrocitica", "gastritis_autoinmune", "anemia_perniciosa"],
    statement:
    ...
    options: [
      ...
      "Anemia ferropénica por menorragia.",
      "Síndrome mielodisplásico.",
    ],
    correct: "B",
    explanation:
...
• ACG Clinical Guidelines for Gastric Atrophy and Pernicious Anemia.`,
  },
  {
    ...
    tags: ["hematologia", "anemia", "megaloblastica", "vitamina_b12"],
    statement:
...
• British Society for Haematology Guidelines on Vitamin B12 Deficiency.`,
  },
  {
    ...
    tags: ["hematologia", "aplasia_medular", "pancitopenia"],
    statement:
...
• UpToDate: Aplastic Anemia in Adults.`,
  },
  {
    id: 263,
    examArea: "Hematología / Insuficiencia medular",
    tags: ["hematologia", "aplasia_medular", "cloranfenicol"],
    statement:
    ...
    options: [
      "Médula hipercelular con infiltración blástica superior al 20%.",
      "Médula hipocelular con reemplazo por tejido adiposo.",
      "Fibrosis reticulínica difusa con dacriocitos en sangre periférica.",
      "Hiperplasia eritroide con megaloblastosis intensa.",
    ],
    correct: "B",
    explanation:
...
• UpToDate: Acquired Aplastic Anemia in Adults.`,
  },
  {
    ...
    tags: ["hematologia", "aplasia_medular", "metimazol", "antitiroideos"],
    statement:
    ...
    options: [
      "Leucemia mieloide aguda.",
      "Síndrome mielodisplásico.",
      "Aplasia medular inducida por metimazol.",
...
• UpToDate: Antithyroid Drug-Induced Agranulocytosis and Aplastic Anemia.`,
  },
  {
    ...
    tags: ["hematologia", "drepanocitosis", "anemia_hemolitica", "crisis_vasooclusiva"],
    statement:
    ...
    options: [
      "La esplenomegalia es un hallazgo frecuente en los cuadros crónicos del adulto.",
      "Puede producir episodios dolorosos por crisis vasooclusivas.",
      "Es debida a un defecto congénito en las proteínas de la membrana eritrocitaria.",
      "La prueba de Coombs suele ser positiva durante las crisis.",
    ],
    correct: "B",
    explanation:
...
• UpToDate: Clinical Manifestations of Sickle Cell Disease.`,
  },
  {
    ...
    tags: ["hematologia", "anemia_hemolitica", "autoinmune", "les", "coombs"],
    statement:
    ...
    options: [
      "Dosificación sérica de vitamina B12.",
...
• EULAR Recommendations for Systemic Lupus Erythematosus.`,
  },
  {
    id: 267,
    examArea: "Hematología / Anemias hemolíticas adquiridas",
    tags: ["hematologia", "anemia_hemolitica", "coombs", "hemolisis"],
    statement:
    ...
    options: [
      "Se trata de una anemia hemolítica; para determinar su naturaleza debemos solicitar una electroforesis de hemoglobinas.",
      "Se trata de una anemia hemolítica; debemos solicitar un test de Coombs directo, que determina la presencia de IgG y/o la fracción C3 del complemento sobre la membrana del hematíe.",
      "Se trata de una anemia hemolítica; debemos solicitar un test de Coombs directo, que determina la presencia de IgG libre en plasma.",
      "Se trata de una anemia hemolítica; para determinar su naturaleza debemos solicitar una prueba de Coombs indirecto.",
    ],
    correct: "B",
    explanation:
...
• ASH Guidelines for Autoimmune Hemolytic Anemia.`,
  },
  {
    id: 268,
    examArea: "Hematología / Anemias hemolíticas hereditarias",
    tags: ["hematologia", "esferocitosis", "anemia_hemolitica", "chcm"],
    statement:
...
• British Society for Haematology Guidelines on Hereditary Spherocytosis.`,
  },
  {
    ...
    tags: ["hematologia", "anemia_hemolitica", "esquistocitos", "microangiopatica"],
    statement:
    ...
    options: [
      "Hemólisis extravascular inmunológica.",
      "Hemólisis extravascular no inmunológica.",
      "Hemólisis intravascular no inmunológica.",
      "Hemólisis intravascular inmunológica.",
    ],
    correct: "C",
    explanation:
...
• ASH Guidelines for Hemolytic Anemias.`,
  },
  {
    ...
    tags: ["hematologia", "anemia_hemolitica", "autoinmune", "anticuerpos_calientes", "coombs"],
    statement:
...
• UpToDate: Cold Agglutinin Disease.`,
  },
  {
    id: 271,
    examArea: "Hematología / Anemias hemolíticas autoinmunes",
    tags: ["hematologia", "anemia_hemolitica", "aglutininas_frias", "coombs"],
    statement:
...
• ASH Guidelines for Autoimmune Hemolytic Anemia.`,
  },
  {
    ...
    tags: ["hematologia", "g6pd", "anemia_hemolitica", "bite_cells"],
    statement:
...
• ASH Guidelines on Hemolytic Anemias.`,
  },
  {
    id: 273,
    examArea: "Hematología / Anemias hemolíticas adquiridas",
    tags: ["hematologia", "hpn", "hemoglobinuria", "trombosis"],
    statement:
...
• ASH Guidelines for Paroxysmal Nocturnal Hemoglobinuria.`,
  },
  {
    ...
    tags: ["hematologia", "drepanocitosis", "electroforesis", "diagnostico"],
    statement:
...
• UpToDate: Diagnosis of Sickle Cell Disease.`,
  },
  {
    ...
    tags: ["hematologia", "drepanocitosis", "crisis_vasooclusiva", "manejo"],
    statement:
    ...
    options: [
      "Transfusión inmediata de glóbulos rojos.",
      "Hidratación intravenosa, analgesia adecuada y oxígeno solo si existe hipoxemia.",
...
// Write first batch - will append more in subsequent runs
...
const pillsPath = path.join(
  __dirname,
  "../src/data/hematologia-banco-theory-pills.ts",
);

const pillsOnly = process.argv.includes("--pills-only");

const pillsEntries = questions
  .filter((q) => q.id >= 263)
  .map((q) => `  "dr-q-${q.id}": \`${escapeTemplate(q.theory)}\`,`)
  .join("\n");

const pillsHeader = `/** Teoría del banco general de hematología (dr-q-263 a dr-q-275). */
export const HEMATOLOGIA_BANCO_THEORY_PILLS: Record<string, string> = {
`;
...
fs.writeFileSync(pillsPath, pillsHeader + pillsEntries + pillsFooter, "utf8");
console.log(
  `Wrote ${questions.filter((q) => q.id >= 263).length} theory pills to ${pillsPath}`,
);
