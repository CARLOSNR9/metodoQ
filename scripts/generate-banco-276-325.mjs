...
const outPath = path.join(
  __dirname,
  "../src/data/dr-q-banco-general-276-325-questions.ts",
);

/** @type {Array<{id:number,examArea:string,topic:string,difficulty:string,tags:string[],statement:string,options:string[],correct:string,explanation:string,keyPoints:string[],theory:string}>} */
const questions = [
  {
    id: 276,
    ...
    difficulty: "hard",
    tags: ["medicina_interna","tromboembolismo_pulmonar"],
    ...
    options: [
      "Anticoagulación con heparina de bajo peso molecular y observación.",
      "Solicitar angiotomografía pulmonar antes de iniciar tratamiento.",
      "Trombólisis sistémica inmediata.",
    ...
    theory: `EXPLICACIÓN DEL PROFE BY DR Q
...
• CHEST Guidelines for Venous Thromboembolism.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","emergencias_endocrinologicas"],
    ...
    options: [
      "Insulina intravenosa → líquidos intravenosos → corrección de potasio.",
      "Bicarbonato intravenoso → insulina intravenosa → líquidos intravenosos.",
      "Líquidos intravenosos → evaluación/corrección de potasio → insulina intravenosa.",
      "Insulina subcutánea → líquidos intravenosos → bicarbonato intravenoso."
    ],
    correct: "C",
...
• Williams Textbook of Endocrinology.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","sepsis_y_choque_septico"],
    ...
    options: [
      ...
      "Iniciar vasopresores inmediatamente.",
      "Administrar antibióticos de amplio espectro dentro de la primera hora.",
      "Solicitar urocultivo y esperar resultados antes de iniciar tratamiento."
    ],
    correct: "C",
...
• Singer M. The Third International Consensus Definitions for Sepsis and Septic Shock (Sepsis-3).`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","emergencias_neurologicas"],
    ...
    options: [
      "Administrar fenitoína intravenosa como primera medida.",
      "Administrar lorazepam o diazepam intravenoso.",
      "Iniciar infusión de propofol inmediatamente.",
      "Administrar levetiracetam oral."
    ],
    correct: "B",
...
• Adams and Victor's Principles of Neurology.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","trastornos_hidroelectroliticos"],
    ...
    options: [
      "Administrar insulina regular con dextrosa.",
      "Iniciar hemodiálisis urgente.",
      "Administrar gluconato de calcio intravenoso.",
...
• European Resuscitation Council Guidelines.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","sindrome_coronario_agudo"],
    ...
    options: [
      "Disminuir el consumo miocárdico de oxígeno mediante betabloqueadores.",
      "Lograr la reperfusión coronaria lo más rápido posible.",
      "Controlar el dolor con opioides intravenosos.",
      "Prevenir arritmias ventriculares mediante amiodarona profiláctica."
    ],
    correct: "B",
...
• UpToDate: Acute ST-Elevation Myocardial Infarction.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","infecciones_del_sistema_nervioso_central"],
    ...
    options: [
      "Iniciar ceftriaxona y vancomicina inmediatamente sin estudios adicionales.",
      "Realizar punción lumbar de forma inmediata antes de cualquier imagen.",
      "Solicitar tomografía cerebral antes de realizar la punción lumbar.",
      "Iniciar dexametasona y dar de alta con seguimiento ambulatorio."
    ],
    correct: "C",
...
• Adams and Victor's Principles of Neurology.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","crisis_hipertensivas"],
    ...
    options: [
      "Reducir la presión arterial hasta valores normales (<120/80 mmHg).",
      "Disminuir la presión arterial media aproximadamente un 20-25% durante la primera hora.",
      "Reducir la presión arterial sistólica por debajo de 140 mmHg en los primeros 30 minutos.",
      "Reducir la presión arterial diastólica por debajo de 90 mmHg en la primera hora."
    ],
    correct: "B",
...
• Braunwald's Heart Disease.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","insuficiencia_cardiaca_aguda"],
...
• American Heart Association Guidelines for Heart Failure.`,
  },
  {
    ...
    topic: "Medicina Interna",
    difficulty: "hard",
    tags: ["medicina_interna","complicaciones_del_infarto_agudo_de_mioc"],
    ...
    options: [
      "Administrar bolo rápido de solución salina al 0.9%.",
      "Iniciar nitroglicerina intravenosa para disminuir la congestión pulmonar.",
      "Iniciar soporte inotrópico urgente y activar estrategia de reperfusión/revascularización.",
      "Administrar furosemida como única medida inicial."
    ],
    correct: "C",
...
• American Heart Association Guidelines for STEMI and Cardiogenic Shock.`,
  },
  {
    ...
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","emergencias_obstetricas_del_primer_trime"],
    ...
    options: [
      "Solicitar β-hCG cuantitativa seriada y observación hospitalaria.",
      "Administrar metotrexato intramuscular.",
      "Realizar laparoscopia diagnóstica programada.",
      "Reanimación hemodinámica inmediata y laparotomía exploratoria urgente."
    ],
    correct: "D",
...
• FIGO Guidelines for Ectopic Pregnancy.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","trastornos_hipertensivos_del_embarazo"],
    ...
    options: [
      "Manejo expectante con vigilancia materno-fetal hasta completar 37 semanas.",
      "Administrar sulfato de magnesio, controlar la hipertensión e iniciar finalización del embarazo una vez estabilizada la madre.",
      "Administrar corticoides para maduración pulmonar y dar egreso con seguimiento estrecho.",
      "Solicitar proteinuria de 24 horas antes de establecer conducta definitiva."
    ],
    correct: "B",
...
• ISSHP Guidelines for Hypertensive Disorders of Pregnancy.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","hemorragias_obstetricas_del_tercer_trime"],
    ...
    options: [
      "Placenta previa sangrante; realizar ecografía transvaginal urgente antes de cualquier intervención.",
      "Desprendimiento prematuro de placenta normoinserta (DPPNI) grave; estabilización materna y cesárea urgente.",
      "Rotura uterina; inducción del trabajo de parto para finalizar rápidamente la gestación.",
      "Trabajo de parto pretérmino con sufrimiento fetal; administrar tocolíticos y corticoides antenatales."
    ],
    correct: "B",
...
• FIGO Recommendations on Obstetric Hemorrhage.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","hemorragia_posparto"],
...
• UpToDate: Management of Postpartum Hemorrhage.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","urgencias_ginecologicas"],
    ...
    options: [
      "Observación hospitalaria y repetición de ecografía Doppler en 24 horas.",
      "Inicio de antibióticos de amplio espectro por sospecha de enfermedad pélvica inflamatoria.",
      "Laparoscopia urgente con detorsión ovárica y preservación del ovario si es viable.",
      "Ooforectomía derecha inmediata."
    ],
    correct: "C",
...
• Berek & Novak's Gynecology.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","infecciones_ginecologicas"],
    ...
    options: [
      "Azitromicina oral en dosis única y control ambulatorio.",
      "Ceftriaxona intramuscular más doxiciclina y metronidazol.",
      "Legrado uterino diagnóstico.",
      "Histerectomía subtotal urgente."
    ],
    correct: "B",
...
• UpToDate: Pelvic Inflammatory Disease in Adult Women.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","hemorragias_del_tercer_trimestre"],
    ...
    options: [
      ...
      "Ecografía obstétrica con evaluación de la localización placentaria.",
      "Inducción inmediata del trabajo de parto."
    ],
    correct: "C",
...
• Gabbe's Obstetrics: Normal and Problem Pregnancies.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","sangrado_uterino_anormal"],
    ...
    options: [
      "Solicitar niveles séricos de FSH y estradiol.",
      "Iniciar tratamiento hormonal empírico y reevaluar en 6 meses.",
      "Realizar biopsia endometrial.",
      "Solicitar resonancia magnética pélvica."
    ],
    correct: "C",
...
• NCCN Guidelines for Endometrial Cancer.`,
  },
  {
    ...
    topic: "Ginecología y Obstetricia",
    difficulty: "medium",
    tags: ["ginecologia_y_obstetricia","infecciones_obstetricas"],
    ...
    options: [
      "Ruptura prematura de membranas sin infección; manejo expectante.",
      "Corioamnionitis clínica; iniciar antibióticos intravenosos de amplio espectro y finalizar el embarazo.",
      "Desprendimiento prematuro de placenta normoinserta; cesárea urgente.",
      "Preeclampsia grave; iniciar sulfato de magnesio."
    ],
    correct: "B",
...
• ISSHP Guidelines for Hypertensive Disorders of Pregnancy.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","alteracion_aguda_del_estado_mental"],
    ...
    options: [
      "Solicitar resonancia magnética cerebral urgente para descartar accidente cerebrovascular.",
      "Iniciar haloperidol intravenoso de forma rutinaria y permanente.",
      "Diagnosticar demencia de inicio reciente e iniciar inhibidores de acetilcolinesterasa.",
      "Identificar y corregir causas precipitantes, implementar medidas no farmacológicas para delirium y reservar antipsicóticos solo si existe riesgo para el paciente o el personal."
    ],
    correct: "D",
...
• Tintinalli's Emergency Medicine.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","emergencias_neuropsiquiatricas"],
    ...
    options: [
      "Catatonia maligna; administrar benzodiacepinas y continuar haloperidol.",
      "Síndrome serotoninérgico; suspender haloperidol e iniciar ciproeptadina.",
      "Meningoencefalitis bacteriana; iniciar antibióticos de amplio espectro.",
      "Síndrome neuroléptico maligno; suspender inmediatamente el antipsicótico e iniciar tratamiento de soporte intensivo."
    ],
    correct: "D",
...
• DSM-5-TR.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","trastorno_bipolar"],
...
• UpToDate: Treatment of Acute Mania in Bipolar Disorder.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","psicofarmacologia_y_reacciones_adversas_"],
    ...
    options: [
      "Bloqueo masivo de receptores dopaminérgicos D2 en sistema nervioso central.",
      "Hiperestimulación serotoninérgica central y periférica por exceso de serotonina sináptica.",
      "Disminución aguda de la actividad gabaérgica cortical.",
      "Hiperactividad colinérgica secundaria a inhibición de la acetilcolinesterasa."
    ],
    correct: "B",
...
• Tintinalli's Emergency Medicine.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","trastornos_por_consumo_de_sustancias"],
...
• ASAM Clinical Practice Guideline on Alcohol Withdrawal Management.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","psiquiatria_de_urgencias"],
    ...
    options: [
      "Riesgo bajo; manejo ambulatorio con cita prioritaria por psiquiatría.",
      "Riesgo moderado; iniciar antidepresivo y control semanal.",
      "Riesgo alto; hospitalización psiquiátrica y medidas de protección inmediata.",
      "Riesgo bajo porque no tiene intentos suicidas previos."
    ],
    correct: "C",
...
• Harrison's Principles of Internal Medicine.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","psiquiatria_de_enlace_y_diagnostico_dife"],
    ...
    options: [
      "Iniciar inmediatamente un ISRS y control ambulatorio en 4 semanas.",
      "Diagnosticar trastorno delirante persistente y solicitar psicoterapia.",
      "Buscar activamente una causa médica u orgánica subyacente, especialmente una neoplasia.",
      "Iniciar benzodiacepinas por posible trastorno de ansiedad."
    ],
    correct: "C",
...
• Textbook of Consultation-Liaison Psychiatry.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","psicofarmacologia"],
    ...
    options: [
      "Iniciar antibiótico empírico ambulatorio y continuar la clozapina.",
      "Solicitar hemograma urgente con recuento absoluto de neutrófilos y suspender temporalmente la clozapina hasta aclarar el diagnóstico.",
      "Aumentar la dosis de clozapina por posible recaída psicótica.",
      "Solicitar únicamente proteína C reactiva y dar seguimiento ambulatorio."
    ],
    correct: "B",
...
• Maudsley Prescribing Guidelines in Psychiatry.`,
  },
  {
    ...
    options: [
      "Iniciar risperidona oral y programar valoración ambulatoria por psiquiatría.",
      "Solicitar resonancia magnética cerebral antes de cualquier intervención.",
      "Controlar primero la agitación mediante sedación farmacológica y garantizar la seguridad del paciente y del personal.",
      "Iniciar inmediatamente tratamiento de mantenimiento para esquizofrenia."
    ],
    correct: "C",
...
• American Association for Emergency Psychiatry Guidelines.`,
  },
  {
    ...
    topic: "Psiquiatría",
    difficulty: "medium",
    tags: ["psiquiatria","sindrome_confusional_agudo"],
...
• Tintinalli's Emergency Medicine.`,
  },
  {
    ...
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","tamizacion_de_cancer_de_cuello_uterino"],
    ...
    options: [
      "Realizar citología cervical anual por ser fumadora.",
      "Realizar prueba de ADN para VPH de alto riesgo y continuar tamización según resultado.",
      "Repetir citología cervical ahora y posteriormente cada 3 años si continúa siendo negativa.",
      "No requiere ninguna prueba hasta cumplir 50 años."
    ],
    correct: "B",
...
• Instituto Nacional de Cancerología de Colombia.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","prevencion_cardiovascular"],
    ...
    options: [
      "Iniciar aspirina a dosis baja de forma indefinida.",
      "Solicitar prueba de esfuerzo para descartar enfermedad coronaria silente.",
      "Implementar un programa estructurado de modificación del estilo de vida con reducción de peso, actividad física regular y cambios dietarios.",
      "Solicitar ecografía Doppler carotídea como tamización cardiovascular."
    ],
    correct: "C",
...
• WHO Guidelines on Cardiovascular Disease Prevention.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","prevencion_y_mantenimiento_de_la_salud"],
    ...
    options: [
      "No requiere ninguna vacuna en este momento porque ya recibió PCV13.",
      "Aplicar únicamente una nueva dosis anual de vacuna contra influenza.",
      "Aplicar vacuna contra influenza y completar el esquema antineumocócico con PPSV23.",
      "Repetir PCV13 y diferir cualquier otra vacunación."
    ],
    correct: "C",
...
• Guías de Promoción y Mantenimiento de la Salud de Colombia.`,
  },
  {
    ...
    options: [
      "No realizar tamización hasta los 50 años porque es un paciente de bajo riesgo.",
      "Solicitar colonoscopia inmediata como única estrategia válida de tamización.",
      "Iniciar tamización para cáncer colorrectal desde este momento mediante una estrategia validada de cribado.",
      "Solicitar sangre oculta en materia fecal únicamente si desarrolla síntomas digestivos."
    ],
    correct: "C",
...
• Guías de Promoción y Mantenimiento de la Salud.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","vigilancia_en_salud_publica"],
    ...
    options: [
      "Iniciar tratamiento antibiótico empírico masivo a toda la población expuesta.",
      "Solicitar pruebas diagnósticas individuales a todos los habitantes de la comunidad antes de intervenir.",
      "Notificar inmediatamente el posible brote al sistema de vigilancia epidemiológica e iniciar la investigación de campo y control de la fuente.",
      "Esperar la confirmación etiológica de todos los casos antes de implementar medidas comunitarias."
    ],
    correct: "C",
...
• Manual de Epidemiología para el Control de Enfermedades Transmisibles.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud"],
    ...
    options: [
      "Calidad técnico-científica de la atención.",
...
• Manual de Atención Primaria en Salud.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","salud_mental_en_atencion_primaria"],
    ...
    options: [
      "Diagnosticar demencia y remitir a neurología para inicio de tratamiento específico.",
      "Solicitar resonancia magnética cerebral urgente para descartar enfermedad neurodegenerativa.",
      "Iniciar abordaje integral de depresión en el adulto mayor, evaluar riesgo suicida, apoyo social y seguimiento estrecho.",
      "Considerar los síntomas como cambios normales asociados al envejecimiento."
    ],
    correct: "C",
...
• Harrison's Principles of Internal Medicine.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","hipertension_arterial"],
    ...
    options: [
      "Repetir la presión arterial en el consultorio durante tres consultas adicionales.",
      "Realizar monitoreo ambulatorio de presión arterial de 24 horas (MAPA).",
      "Solicitar ecocardiograma transtorácico.",
      "Iniciar tratamiento antihipertensivo y reevaluar la respuesta clínica."
    ],
    correct: "B",
...
• Guías de Atención Primaria para Hipertensión Arterial.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","prevencion_de_complicaciones_cronicas_de"],
    ...
    options: [
      "Porque la albuminuria permite diagnosticar infecciones urinarias asintomáticas antes de que produzcan complicaciones.",
      "Porque la albuminuria es un marcador temprano de daño renal y de riesgo cardiovascular, incluso antes de que aparezcan síntomas o aumente la creatinina sérica.",
      "Porque la albuminuria predice el desarrollo de cáncer renal en pacientes diabéticos.",
      "Porque la albuminuria es necesaria para decidir la dosis de insulina utilizada por el paciente."
    ],
    correct: "B",
...
• Brenner & Rector's The Kidney.`,
  },
  {
    ...
    topic: "Atención Primaria en Salud",
    difficulty: "medium",
    tags: ["atencion_primaria_en_salud","promocion_de_la_salud_y_atencion_primari"],
    ...
    options: [
      ...
      "Intervención sobre determinantes sociales y ambientales de la salud.",
...
• Manual de Promoción de la Salud y Prevención de la Enfermedad.`,
  },
  {
    ...
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","inotropicos_y_fisiologia_cardiovascular"],
    ...
    options: [
      "Inhibición de la Na+/K+ ATPasa con aumento secundario del calcio intracelular.",
      "Estimulación de receptores β1 cardíacos con incremento de AMPc y entrada de calcio a la célula.",
      "Bloqueo de receptores muscarínicos cardíacos con aumento de la frecuencia cardíaca.",
      "Inhibición de la fosfodiesterasa con aumento primario de GMPc intracelular."
    ],
    correct: "B",
...
• ESC Guidelines for Acute Myocardial Infarction and Cardiogenic Shock.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","fisiopatologia_del_choque_septico"],
    ...
    options: [
      "Inhibición de la síntesis de AMPc en el músculo liso vascular.",
      "Sobreexpresión de la óxido nítrico sintasa inducible (iNOS) con producción excesiva de óxido nítrico.",
      "Bloqueo de los canales de calcio tipo L del músculo liso vascular.",
      "Disminución de la producción de prostaciclinas por el endotelio vascular."
    ],
    correct: "B",
...
• Marino's The ICU Book.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","trastornos_acido_base"],
    ...
    options: [
      "Producción persistente de cuerpos cetónicos por resistencia a la insulina.",
      "Acumulación de ácido láctico secundaria a hipoperfusión tisular persistente.",
      "Desarrollo de acidosis metabólica hiperclorémica por expansión del compartimento extracelular con solución salina.",
      "Retención renal de fosfatos con aumento del anión gap."
    ],
    correct: "C",
...
• UpToDate: Diabetic Ketoacidosis and Hyperchloremic Metabolic Acidosis.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","fisiologia_respiratoria"],
    ...
    options: [
      "Supresión completa del estímulo respiratorio hipóxico.",
      "Aumento de la producción metabólica de CO₂ por hiperoxia.",
      "Reversión de la vasoconstricción pulmonar hipóxica con incremento del desajuste ventilación/perfusión (V/Q).",
      "Disminución aguda de la afinidad de la hemoglobina por el oxígeno."
    ],
    correct: "C",
...
• Murray & Nadel's Textbook of Respiratory Medicine.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","farmacologia_cardiovascular"],
    ...
    options: [
      "Porque aumenta la eliminación renal de digoxina y genera metabolitos tóxicos.",
      "Porque disminuye la unión de digoxina a proteínas plasmáticas aumentando la fracción libre.",
      "Porque el potasio y la digoxina compiten por el mismo sitio de unión en la Na⁺/K⁺ ATPasa, aumentando la fijación de digoxina cuando el potasio disminuye.",
      "Porque favorece la degradación intracelular de la Na⁺/K⁺ ATPasa."
    ],
    correct: "C",
...
• DiPiro's Pharmacotherapy.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","fisiopatologia_cardiovascular"],
    ...
    options: [
      "Activación de la vía extrínseca de coagulación con formación de microtrombos intracoronarios.",
      "Producción masiva de especies reactivas de oxígeno con sobrecarga intracelular de calcio y daño mitocondrial.",
      "Inhibición de la fosforilación oxidativa por disminución aguda del oxígeno intracelular.",
      "Acumulación progresiva de cuerpos cetónicos dentro del miocito isquémico."
    ],
    correct: "B",
...
• ESC Guidelines for Acute Coronary Syndromes.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","fisiologia_tiroidea_y_farmacologia_endoc"],
    ...
    options: [
      "Inhibición de la síntesis tiroidea de T3 y T4 mediante bloqueo de la peroxidasa tiroidea.",
      "Inhibición de la liberación de hormonas tiroideas almacenadas en el coloide.",
      "Disminución de la conversión periférica de T4 a T3 por inhibición de la 5'-desyodasa.",
      "Aumento de la depuración hepática de hormonas tiroideas mediante inducción enzimática."
    ],
    correct: "C",
...
• American Thyroid Association Guidelines for Hyperthyroidism.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","hemostasia_y_farmacologia_de_anticoagula"],
    ...
    options: [
      "Destrucción directa de plaquetas por toxicidad medular inducida por heparina.",
      "Formación de anticuerpos IgG contra complejos heparina-factor plaquetario 4 (PF4), con activación masiva de plaquetas y generación de trombina.",
      "Activación del complemento con hemólisis intravascular y consumo secundario de plaquetas.",
      "Inhibición de la producción hepática de trombopoyetina por efecto directo de la heparina."
    ],
    correct: "B",
...
• American Society of Hematology (ASH) Guidelines on HIT.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","microbiologia_y_fisiopatologia_de_la_end"],
    ...
    options: [
      "Coagulasa.",
      "Proteína A.",
      "Adhesinas de superficie tipo MSCRAMMs (proteínas de unión a fibronectina y fibrinógeno).",
      "Alfa-toxina."
    ],
    correct: "C",
...
• Robbins & Cotran Pathologic Basis of Disease.`,
  },
  {
    ...
    topic: "Ciencias Básicas Aplicadas a la Clínica",
    difficulty: "hard",
    tags: ["ciencias_basicas_aplicadas_a_la_clinica","fisiologia_celular_y_fibrosis_quistica"],
    ...
    options: [
      "Disminución de la secreción de bicarbonato y agua hacia la luz ductal, produciendo secreciones espesas y obstrucción ductal.",
      "Aumento de la secreción de enzimas pancreáticas activadas hacia el conducto pancreático principal.",
      "Incremento de la absorción ductal de bicarbonato con alcalinización excesiva de las secreciones pancreáticas.",
      "Disminución de la síntesis de tripsinógeno con insuficiencia pancreática exocrina primaria."
    ],
    correct: "A",
...
function renderQuestion(q) {
  ...
  const options = q.options
    .map(
      (text, i) =>
        `      { id: "${labels[i]}", label: "${labels[i]}", text: ${JSON.stringify(text)} },`,
    )
    .join("\n");
  ...
  const tags = ['"dr-q"', '"universal"', '"metodoq"', ...q.tags.map((t) => `"${t}"`)];
...
${keyPoints}
    ...
    theoryContent: \`${escapeTemplate(q.theory)}\`,
  }`;
}
...
fs.writeFileSync(outPath, header + questions.map(renderQuestion).join(",\n") + footer, "utf8");
